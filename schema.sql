...
CREATE TABLE address (
                         ...
                         user_email VARCHAR(255) REFERENCES user(user_email),
                         street VARCHAR(255),
...
CREATE TABLE friendship (
                            ...
                            user_id_1 VARCHAR(255) REFERENCES user(user_email),
                            user_id_2 VARCHAR(255) REFERENCES user(user_email),
                            status VARCHAR(50),
                            date_of_change DATE,
                            date_of_creation DATE
);
...
CREATE TABLE interest (
                          ...
                          from_user_id VARCHAR(255) REFERENCES user(user_email),
                          to_user_id VARCHAR(255) REFERENCES user(user_email),
                          date_of_change DATE,
                          date_of_creation DATE
);
...
CREATE TABLE message (
                         ...
                         sender_id VARCHAR(255) REFERENCES user(user_email),
                         receiver_id VARCHAR(255) REFERENCES user(user_email),
                         text TEXT,
